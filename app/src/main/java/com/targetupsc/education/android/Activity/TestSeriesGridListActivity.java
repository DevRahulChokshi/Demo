...
import com.targetupsc.education.android.Adapter.TestSeriesGridListAdapter;
...
public class TestSeriesGridListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TestSeriesGridListAdapter TestSeriesListAdapter = new TestSeriesGridListAdapter(TestSeriesGridListActivity.this, mTestSeriesList);
        recyclerTestSeries.setHasFixedSize(true);
        recyclerTestSeries.setLayoutManager(new GridLayoutManager(this, 2));
